...
$string['ignoreoldgrades_desc'] = 'Активируйте эту опцию, чтобы игнорировать оценки/задания старше заданной даты.';
$string['ignoredate'] = 'Дата игнорирования';
$string['ignoredate_desc'] = 'Задайте дату в формате Unix, и оценки/задания старше этой даты не будут обрабатываться плагином.';
